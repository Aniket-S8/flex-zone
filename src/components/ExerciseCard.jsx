...
export default function ExerciseCard(props) {
  ...
  return (
    <div className="p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap">
        ...
        <div className="grid grind-cols-2 sm:grid-cols-4 sm:place-items-center gap-2">
            ...
            hover:boder-blue-600 w-full duration-200">
                <h3 className="capitalize text-slate-400">Sets completed</h3>
